...
start "Node 1" cmd /k "cd /d %~dp0 && node server.js --port=3000 --node-id=node-1"

timeout /t 2 /nobreak >nul

echo Starting Node 2 on port 3001...
start "Node 2" cmd /k "cd /d %~dp0 && node server.js --port=3001 --node-id=node-2"

timeout /t 2 /nobreak >nul

echo Starting Node 3 on port 3002...
start "Node 3" cmd /k "cd /d %~dp0 && node server.js --port=3002 --node-id=node-3"
